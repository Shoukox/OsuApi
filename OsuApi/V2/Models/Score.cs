...
public record Score
{
    ...
    [JsonPropertyName("best_id")] public long? BestId { get; set; }
    ...
    [JsonPropertyName("has_replay")] public bool? HasReplay { get; set; }

    [JsonPropertyName("id")] public long? Id { get; set; }

    [JsonPropertyName("is_perfect_combo")] public bool? IsPerfectCombo { get; set; }

    [JsonPropertyName("legacy_perfect")] public bool? LegacyPerfect { get; set; }
    ...
    [JsonPropertyName("playlist_item_id")] public int? PlaylistItemId { get; set; }
    ...
    [JsonPropertyName("rank_country")] public int? RankCountry { get; set; }

    [JsonPropertyName("rank_global")] public int? RankGlobal { get; set; }
