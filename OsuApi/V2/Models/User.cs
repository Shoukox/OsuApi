...
public record User
{
    ...
    [JsonPropertyName("account_history")] public UserAccountHistory[]? AccountHistory { get; set; }
    ...
    [JsonPropertyName("badges")] public UserBadge[]? Badges { get; set; }

    [JsonPropertyName("beatmap_playcounts_count")]
    public int? BeatmapPlaycountsCount { get; set; }

    [JsonPropertyName("blocks")] public object? Blocks { get; set; } // idk what is it
    ...
    [JsonPropertyName("friends")] public object? Friends { get; set; } // idk

    [JsonPropertyName("graveyard_beatmapset_count")]
    public int? GraveyardBeatmapsetCount { get; set; }

    [JsonPropertyName("groups")] public UserGroup[]? Groups { get; set; }
    ...
    [JsonPropertyName("rank_highest")] public UserRankHighest? RankHighest { get; set; }
    ...
    [JsonPropertyName("session_verified")] public bool? SessionVerified { get; set; }

    [JsonPropertyName("statistics")] public UserStatistics? Statistics { get; set; }
    ...
    [JsonPropertyName("unread_pm_count")] public object? UnreadPmCount { get; set; }

    [JsonPropertyName("user_achievements")]
    public UserAchievement[]? UserAchievements { get; set; }

    [JsonPropertyName("user_preferences")] public object? UserPreferences { get; set; }
